import { UPDATE_QUOTE, UPDATE_QUOTE_LOADING, UPDATE_QUOTE_DONE } from '../actions/quoteActions';
...
describe('quote selectors', () => {
  ...
  it('should handle UPDATE_QUOTE_LOADING', () => {
    const state = {
      loading: false,
      quote: 'testQuote',
      characterName: 'testName',
  ...
  it('should handle UPDATE_QUOTE_DONE', () => {
    const state = {
      loading: false,
      quote: 'testQuote',
      characterName: 'testName',
